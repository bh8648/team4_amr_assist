...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(package='robot_manager', executable='hmi_backend_node', name='hmi_manager_node', output='screen', parameters=[{'db_path': LaunchConfiguration('db_path'), 'map_yaml_path': LaunchConfiguration('map_yaml_path'), 'camera_topic': LaunchConfiguration('camera_topic')}]),
