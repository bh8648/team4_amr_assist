...
from robot_status.msg import RobotAssignment, RobotStatus
...
class DbManagerNode(Node):
    def __init__(self):
        ...
        self.last_msg_time = {}   # { robot_id(int): timestamp_sec }
        self.latest_status = {}   # { robot_id(int): msg_data }
        ...
        # 3-2. Robot Error Subscriber 설정 (오류 발생 시 수신)
    ...
    def assignment_callback(self, msg):
        ...
        assigned_at = datetime.fromtimestamp(
            msg.assigned_at.sec + msg.assigned_at.nanosec / 1e9
        ...
        try:
            ...
            self.get_logger().info(
                f'작업 {task_id} 저장 완료: AMR {msg.robot_id}, '
                f'목표 ({msg.target_x:.2f}, {msg.target_y:.2f})'
            )
        except sqlite3.Error as e:
    ...
    def save_status_to_db(self):
        ...
        for robot_id, msg in self.latest_status.items():
            ...
            robot_state = "IDLE"
            task_id = msg.current_task_id or None
